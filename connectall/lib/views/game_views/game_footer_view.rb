module Views
  class GameFooterView
    def initialize(window, controller, game_state_model)
      ...
      @concede = BtnItem.new(@window, Gosu::Image.new("assets/images/btn_concede.png", :tileable => true), 169, 470 + 10, 35, lambda { @controller.reset_button_click }, Gosu::Image.new("assets/images/btn_concede_click.png", :tileable => true))
      @status_buttons << @skip
